					...
					<div class="form-group">
						<div class="row" >
							<div class="col-sm-12">
								...
								<input type="text" name="terminal_type_name" placeholder="Name" autocomplete="off" class="form-control" value="<?= $device_type_name->terminal_type_name ?>" required>
...
<script type="text/javascript">
	...
	$("#form_edit").submit(function(event){
		...
		$.ajax({
			url: '<?php echo site_url(); ?>device/type/action_edit',
			type: "POST",
