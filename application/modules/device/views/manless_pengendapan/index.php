		...
		<div id="toolbar">
			<div class="row">
				<div class="col col-md-8" style="padding: 5px 15px">
					<?php if ($add) {
						create_btn(site_url('device/manless_pengendapan/add'),'Add','plus-circle2');
					} ?>
				</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('#grid').datagrid({
			url         : '<?php echo site_url('device/manless_pengendapan/getList'); ?>',
	...
	function edit(id){
		$.magnificPopup.open({
			items: {
				src: "<?php echo site_url('device/manless_pengendapan/edit/') ?>"+id,
			},
			modal: true,
			type: 'ajax',
	...
	{
		var url = "<?php echo site_url('device/manless_pengendapan/update_password/') ?>"+id;
		swal({
	...
	{
		var url="<?php echo site_url('device/manless_pengendapan/delete/') ?>"+id+"/"+msg;
		swal({
