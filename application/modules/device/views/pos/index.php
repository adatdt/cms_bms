		...
		<div id="toolbar">
			<div class="row">
				<div class="col col-md-5" style="padding: 5px 15px">
					<?php if ($add) {
						create_btn(site_url('device/pos/add'),'Add','plus-circle2');
					} ?>
				</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('#grid').datagrid({
			url         : '<?php echo site_url('device/pos/getList'); ?>',
			fitColumns : true,
			...
			columns:[[
				...
				{ field: 'terminal_type_name', title: 'Type Device', sortable: true,width:100 },
				{ field: 'status', title: 'Status', sortable: false,width:50,align:"center",halign:"center" },
	...
	function edit(id){
		$.magnificPopup.open({
			items: {
				src: "<?php echo site_url('device/pos/edit/') ?>"+id,
			},
			modal: true,
			type: 'ajax',
	...
	function deleteData(id){
		url = "<?php echo site_url('device/pos/delete/') ?>"+id;
		confirm_delete(url);
	}
