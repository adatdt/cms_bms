	...
	public function  download()
	{
		...
		if (!empty($search))
		{
			$where .="and(  d.plate_number ilike '%".$search."%'
							...
							or d.driver_name ilike '%".$search."%'
						)";
		}

		$sql =  "select h.type,g.bus_name,d.driver_name, e.po_name, d.plate_number, d.route_info, c.shelter_name, b.terminal_name, a.* from trx.t_trx_check_in a 
