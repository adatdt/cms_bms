...
<script type="text/javascript">
	$("#btndownload").click(function(event){
		...
		window.location.href="<?php echo site_url('transaction/check_out/download?') ?>sortFrom="+sortFrom+"&sortTo="+sortTo+"&search="+search+"&shelter="+shelter+"&po="+po;
	});
	...
	$(document).ready(function(){
		$('#grid').datagrid({
			url         : '<?php echo site_url('transaction/check_out/getList'); ?>',
			// pagination : true,
			// rownumbers : true,
			// fitColumns : true,
