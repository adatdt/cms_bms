...
<script type="text/javascript">
	$("#btndownload").click(function(event){
		...
		window.location.href="<?php echo site_url('transaction/check_exit/download?') ?>sortFrom="+sortFrom+"&sortTo="+sortTo+"&search="+search+"&shelter="+shelter+"&po="+po;
	});
	...
	$(document).ready(function(){
		$('#grid').datagrid({
			url         : '<?php echo site_url('transaction/check_exit/getList'); ?>',
			// pagination : true,
			// rownumbers : true,
			// fitColumns : true,
