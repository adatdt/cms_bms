					...
					<div class="form-group">
						<div class="row" >
							...
							<div class="col-sm-3 form-group">
								...
								<input type="text" name="plateNumber" placeholder="Plate Number" autocomplete="off" class="form-control" required value="<?php echo $bus->plate_number; ?>" disabled>
							</div> 

							<div class="col-sm-3 form-group">
								<label>PO Bus <font color="red">*</font></label>
								<select class="form-control" name="po" id="po" required disabled>
...
<script type="text/javascript">
	...
	$("#form_edit").submit(function(event){
		...
		$.ajax({
			url: '<?php echo site_url(); ?>po/bus/action_edit2',
			type: "POST",
