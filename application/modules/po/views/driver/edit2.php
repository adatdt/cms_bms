					...
					<div class="form-group">
						<div class="row" >
							...
							<div class="col-sm-3 form-group">
								...
								<input type="text" name="driver" placeholder="Driver Name" autocomplete="off" class="form-control" required value="<?php echo $detail->driver_name ?>" disabled>
							</div>
							...
							<div class="col-sm-3 form-group">
								...
								<select name="bus" required class="form-control" id="bus" disabled>
...
<script type="text/javascript">
	...
	$("#form_edit").submit(function(event){
		...
		$.ajax({
			url: '<?php echo site_url(); ?>po/driver/action_edit2',
			type: "POST",
