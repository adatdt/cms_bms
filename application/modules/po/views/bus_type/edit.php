					...
					<div class="form-group">
						<div class="row" >
							<div class="col-sm-12">
								...
								<input type="text" name="type" placeholder="Bus Type" autocomplete="off" class="form-control" required value="<?php echo $type->type; ?>">

								<input type="hidden" name="id" placeholder="id" autocomplete="off" class="form-control" required value="<?php echo encode($type->id_seq); ?>">
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	$("#form_edit").submit(function(event){
		...
		$.ajax({
			url: '<?php echo site_url(); ?>po/bus_type/action_edit',
			type: "POST",
