		...
		<div id="toolbar">
			<div class="row">
				<div class="col col-md-8" style="padding: 5px 15px">
					<?php if ($add) {
						create_btn(site_url('po/po/add'),'Add','plus-circle2');
					} ?>
				</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('#grid').datagrid({
			url         : '<?php echo site_url('po/po/getList'); ?>',
			// pagination : true,
			// rownumbers : true,
			// fitColumns : true,
			...
			columns:[[
				...
				// { field: 'po_code', title: 'PO Code', sortable: true, halign:"center",width:100 },
				{ field: 'prefix', title: 'Prefix', sortable: true, halign:"center", align:"center" },
				{ field: 'icon', title: 'Image', sortable: true, halign:"center", align:"center",width:100},
				{ field: 'po_name', title: 'PO Bus', sortable: true, halign:"center",width:100 },
				{ field: 'pic_name', title: 'PIC', sortable: true, halign:"center",width:100 },
				{ field: 'pic_phone', title: 'PIC Phone', sortable: true, halign:"center",width:100 },
				{ field: 'pic_email', title: 'PIC Email', sortable: true, halign:"center",width:100 },
				{ field: 'address', title: 'Address PO', sortable: true, halign:"center",width:100 },
	...
	function edit(id){
		$.magnificPopup.open({
			items: {
				src: "<?php echo site_url('po/po/edit/') ?>"+id,
			},
			modal: true,
			type: 'ajax',
	...
	function deleteData(id){
		url = "<?php echo site_url('po/po/delete/') ?>"+id;
		confirm_delete(url);
	}
