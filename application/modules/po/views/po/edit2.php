...
<!-- 							<div class="col-sm-2 form-group">
							...
							<div class="col-sm-3 form-group">
								...
								<input type="text" name="poName" placeholder="PO Bus" autocomplete="off" class="form-control" value="<?php echo $po->po_name; ?>" required disabled>
							</div>
...
<script type="text/javascript">
	...
	$("#form_edit").submit(function(event){
		...
		$.ajax({
			url: '<?php echo site_url(); ?>po/po/action_edit2',
			type: "POST",
