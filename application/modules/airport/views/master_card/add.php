					...
					<div class="form-group">
						<div class="row" >
							...
							<div class="col-sm-12 form-group">
								...
								<input type="text" name="name" placeholder="PIC Name" autocomplete="off" class="form-control" required>
							</div>

							<div class="col-sm-12 form-group">
								<label>PIC Phone <font color="red">*</font></label>
								<input type="text" name="phone" placeholder="Ex.081xxx" autocomplete="off" class="form-control" required>
							</div> 
...
<script type="text/javascript">
	...
	$("#form_add").submit(function(event){
		...
		$.ajax({
			url: '<?php echo site_url(); ?>airport/master_card/action_add',
			type: "POST",
