					...
					<div class="form-group">
						<div class="row" >
							<div class="col-sm-12 form-group">
								...
								<select name="shelter_id" class="form-control">
							...
							<div class="col-sm-12 form-group">
								...
								<input type="text" name="lane_name" placeholder="Lane Name" autocomplete="off" class="form-control" required>
							</div> 
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	$("#form_add").submit(function(event){
		...
		$.ajax({
			url: '<?php echo site_url(); ?>airport/lane/action_add',
			type: "POST",
